...
constexpr int kTensorArenaSize = 30 * 1024 + 1360;
...
void setup() {
  ...
  printf("model_input_buffer: %i", model_input_buffer);
...
printf("time per inference: %luus \n", t1-t0);

  // Obtain a pointer to the output tensor
  TfLiteTensor *output = interpreter->output(0);

  // printf("Model output [t=%6lu]: <%4d, %4d, %4d, %4d>\n", time_us_32(), output->data.int8[0],
  //                                                                  output->data.int8[1],
  //                                                                  output->data.int8[2],
  //                                                                  output->data.int8[3]);
